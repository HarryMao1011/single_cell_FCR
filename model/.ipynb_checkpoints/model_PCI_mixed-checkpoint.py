...
class VCI(nn.Module):
    ...
    def intervention_decode(self, ZT, latent_control):
        ...
        # print("internvention decoder similarity shape {}".format(inputs.shape))
    ...
    def loss_paired(self, control_outcomes, control_outcomes_dist_samp,
        ...
        return (indiv_spec_nllh_control, indiv_spec_nllh_experiments, cov_loss, treatment_loss,
                kl_divergence_ind, kl_divergence_X, kl_divergence_T, kl_divergence_XT,kl_divergence_control)
    ...
    def forward(self, outcomes, treatments, contol_outcomes, covariates,
        ...
        # print("exp_dist.mean shape {},  exp_dist.stddev shape {}".format(exp_dist.mean.shape, exp_dist.stddev.shape))
        ...
        ## control share this prior with treatment
        ## p(z_x|x) prior
